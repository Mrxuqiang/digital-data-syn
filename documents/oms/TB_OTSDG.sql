...
================================================================================
*/
select * from user_tables where table_name like '%TB_OTS%'
...
create table TB_OTSDG  (
   ...
   OTSDG002             VARCHAR2(100)                   not null,  /*SAP公司代码          */
   OTSDG003             INTEGER                         not null,  /*OMS费用项ID            */
   OTSDG004             VARCHAR2(100)                   not null,  /*SAP费用科目          */
   OTSDG005             VARCHAR2(200)                   not null,  /*SAP承诺项目          */
